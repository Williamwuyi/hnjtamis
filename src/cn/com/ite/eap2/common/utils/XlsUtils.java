...
public class XlsUtils {
	 ...
	 * @modified
	 */
	public static XlsUtils createWrite(File xls) throws Exception{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void write(int tagIndex,String tagName,Collection coll,String[] colMap,String[] titles) throws Exception{
