...
/**
 * <p>Title com.ite.oxhide.common.util.ChineseTimeJudge</p>
 * <p>Description 农历计算工具类</p>
 * <p>Company ITE </p>
 * <p>Copyright Copyright(c)2009</p>
 * @author 宋文科
 * @create time: 2009-9-21 下午05:27:50
 * @version 1.0
 * 
 * @modified records:
 */
public class ChineseTimeJudge {
	public static void main(String[] args) {
		// 调用阳历日期转换农历日期方法
		System.out.println(ChineseTimeJudge.sCalendarSolarToLundar(2009, 9,3));
	}
	// Array lIntLunarDay is stored in the monthly day information in every
	// year from 1901 to 2100 of the lunar calendar,
	// The lunar calendar can only be 29 or 30 days every month, express
	// with 12(or 13) pieces of binary bit in one year,
	// it is 30 days for 1 form in the corresponding location , otherwise it
	// is 29 days
	...
	// Array iLunarLeapMonthTable preserves the lunar calendar leap month
	// from 1901 to 2050,
