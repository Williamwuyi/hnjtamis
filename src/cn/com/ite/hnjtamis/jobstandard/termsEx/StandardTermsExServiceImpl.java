 ...
 * 岗位标准管理
 * @author 朱健
 * @create time: 2016年3月4日 上午9:00:52
 * @version 1.0
 * 
 * @modified records:
 */
public class StandardTermsExServiceImpl extends DefaultServiceImpl implements StandardTermsExService {
	...
	public List<TreeNode> getStandardModelTree(){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.getStandardModelTree();
	}
	/**
	 * 根据老的题库ID更新为新的题库ID
	 * @author 朱健
	...
	public void updateStandardQuarterBank(String standardid,String newBankId,String oldBankId){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		standardTermsExDao.updateStandardQuarterBank(standardid, newBankId, oldBankId);
	}
	...
	public void updateMoreStandardQuarterBank(String standardid){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		standardTermsExDao.updateMoreStandardQuarterBank(standardid);
	}
	...
	public Map<String,List<ThemeBank>> queryBankIdByStandardQuarter(String standardid){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryBankIdByStandardQuarter(standardid);
	}
	/**
	 * 根据类型查询岗位信息
	 * @author 朱健
	...
	public List<StandardTerms> queryStandardTermsByTypeId(String typeId,Map paramMap){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryStandardTermsByTypeId(typeId,paramMap);
	}
	...
	public List<StandardTerms> queryStandardTermsByParentTypeId(String typeId,Map paramMap){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryStandardTermsByParentTypeId(typeId,paramMap);
	}
	...
	public List<StandardTerms> queryStandardTermsByQuarterId(String typeId,Map paramMap){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryStandardTermsByQuarterId(typeId,paramMap);
	}
	...
	public List<StandardTerms> getStandardTopTypeList(){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.getStandardTopTypeList();
	}
	...
	public List<StandardTerms> queryUnStandardTermsByQuarterId(String typeId,Map paramMap){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryUnStandardTermsByQuarterId(typeId,paramMap);
	}
	...
	public List<StandardTerms> queryAllStandardTerms(Map paramMap){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.queryAllStandardTerms(paramMap);
	}
	...
	public EmployeeLearningForm getEmployeeStandardLearning(String employeeId){
		StandardTermsExDao standardTermsExDao = (StandardTermsExDao)this.getDao();
		return standardTermsExDao.getEmployeeStandardLearning(employeeId);
	}
}
