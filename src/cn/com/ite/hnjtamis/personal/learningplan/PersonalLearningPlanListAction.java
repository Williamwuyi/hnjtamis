 ...
 * @modified records:
 */
public class PersonalLearningPlanListAction extends AbstractListAction {
	 ...
	 * 查询结果
	 */
	private List<PersonalLearningPlan> list = new ArrayList<PersonalLearningPlan>();
...
//			this.setValid(this.getValidStr().equals("1"));
		list = (List<PersonalLearningPlan>)service.queryData("queryHql", this,null,this.getStart(),this.getLimit());
		//把线性结构转成树形结构
...
//				"baseSpecialities",new String[]{},null,this.getFilterIds(),"orderno",null);
	...
	public String delete() throws Exception{
		...
		service.deleteByKeys(this.getId().split(","), PersonalLearningPlan.class);
		this.setMsg("信息删除成功！");
		return "delete";
	}
	
	 
	public List<PersonalLearningPlan> getList() {
		return list;
	}
	public void setList(List<PersonalLearningPlan> list) {
		this.list = list;
	}
