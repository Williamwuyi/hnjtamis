 ...
 * <p>Description 个人学习信息提醒ListAction</p>
 * <p>Company ITE </p>
 ...
 * @modified records:
 */
public class PersonalRemindListAction extends AbstractListAction {
	 ...
	 * 查询结果
	 */
	private List<PersonalRemind> list = new ArrayList<PersonalRemind>();
...
//			this.setValid(this.getValidStr().equals("1"));
		list = (List<PersonalRemind>)service.queryData("queryHql", this,null,this.getStart(),this.getLimit());
		//把线性结构转成树形结构
...
//				"baseSpecialities",new String[]{},null,this.getFilterIds(),"orderno",null);
	...
	public String delete() throws Exception{
		...
		service.deleteByKeys(this.getId().split(","), PersonalRemind.class);
		this.setMsg("信息删除成功！");
		return "delete";
	}
	
	 
	public List<PersonalRemind> getList() {
		return list;
	}
	public void setList(List<PersonalRemind> list) {
		this.list = list;
	}
