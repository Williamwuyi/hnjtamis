...
/**
 * TestAfterStudy entity. @author MyEclipse Persistence Tools
 */

public class TestAfterStudy implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4147604241894944665L;
	private String id;
	...
	/** default constructor */
	public TestAfterStudy() {
	}

	/** full constructor */
	public TestAfterStudy(ExamTestpaper examTestpaper, TrainOnline trainOnline,
			String studentId, Double score, Integer isDel, Integer syncStatus,
			String lastUpdateDate, String lastUpdatedBy, String creationDate,
			String createdBy, String organId) {
