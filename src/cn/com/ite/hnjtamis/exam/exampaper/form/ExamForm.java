...
public class ExamForm {
	...
	private String isExam;//是否考试科目  10-是 20-否
	private List<ExamForm> examList = new ArrayList<ExamForm>();
	private ExamTestpaperForm testpaper;
	
	
	private String haveUserReviewExam;//是否存在手工阅卷
	private String haveYjr;//是否配置阅卷人
	...
	public String getHaveUserReviewExam() {
		return haveUserReviewExam;
	}
	public void setHaveUserReviewExam(String haveUserReviewExam) {
		this.haveUserReviewExam = haveUserReviewExam;
	}
	public String getHaveYjr() {
		return haveYjr;
	}
	public void setHaveYjr(String haveYjr) {
		this.haveYjr = haveYjr;
	}
