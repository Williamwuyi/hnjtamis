...
public class ExamArrangeForm {
	...
	private Integer examPaperType;//出题方式
	...
	private List<ExamForm> examFormList = new ArrayList<ExamForm>();
	...
	private ExamTestpaperForm testpaper;//试卷模版ID
	...
	public List<ExamForm> getExamFormList() {
		return examFormList;
	}

	public void setExamFormList(List<ExamForm> examFormList) {
