...
/**
 * StudyUserAnswerkeyHis entity. @author MyEclipse Persistence Tools
 * 学习考生答题结果表(历史信息)
 */

public class StudyUserAnswerkeyHis implements java.io.Serializable {
	...
	/** default constructor */
	public StudyUserAnswerkeyHis() {
	}

	/** full constructor */
	public StudyUserAnswerkeyHis(String studyTestpaperThemeId,
			...
			String syncFlag, String inTime, String outTime, String subTime,
