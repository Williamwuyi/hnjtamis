...
/**
 * TestpaperThemeSkey entity. @author MyEclipse Persistence Tools
 */

public class TestpaperThemeSkey implements java.io.Serializable {

	// Fields

	private String searchKeyId;
	private TestpaperTheme testpaperTheme;
	...
	/** default constructor */
	public TestpaperThemeSkey() {
	}

	/** full constructor */
	public TestpaperThemeSkey(TestpaperTheme testpaperTheme, String themeId,
			String professionId, String professionName,
			String professionLevelCode, String postId, String postName,
			String postLevelCode, String themeBankId,String themeBankName,Integer sortNum, String bankLevelCode,
