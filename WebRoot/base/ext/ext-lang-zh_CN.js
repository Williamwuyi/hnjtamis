...
var eap_operate_otherterm='更多条件';
var eap_operate_query='查询';
var eap_operate_add='增加';
var eap_operate_update='修改';
var eap_operate_delete='删除';
var eap_operate_view='查看';
var eap_operate_order='排序';
var eap_operate_viewpopdem='查看权限';
var eap_operate_takerole='分配角色';
var eap_operate_movetop='移到顶端';
var eap_operate_moveup='上移一行';
var eap_operate_movedown='下移一行';
var eap_operate_movebuttom='下移底端';
var eap_operate_saveorder='保存排序';
var eap_operate_close='关闭';
var eap_operate_save='保存';
var eap_operate_ok='确认';
var eap_operate_clear='清除';
var eap_operate_addrow='添加一行';
var eap_operate_retpass='重置密码';
var eap_operate_moveto='移至指定行';
var eap_operate_all_select='全选';
var eap_operate_all_clear='全消';
var eap_operate_back_select='反选';
var eap_page_accessorymanger='附件管理';
var eap_list_displayMsg='显示第{0}条到{1}条记录，一共{2}条';
var eap_list_emptyMsg='没有记录';
var eap_tree_select_emptyText='已选择结点名称';
var eap_tree_filterterm_emptyText='过滤条件';