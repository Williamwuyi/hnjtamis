...
*/
Ext.define('base.core.HtmlEditorImage', {
    extend: 'Ext.util.Observable',
    alias: 'widget.HtmlEditorImage',
    langTitle: '插入图片',
    imageWidth:'',
    imageHight:'',
    ...
    saveUploadImg: function (btn, view) {
        ...
        if(fileName == undefined || fileName == null || fileName==''){
			...
			formObj.getForm().submit({
				...
				waitMsg:'正在上传,请稍候...',
				timeout: 600000,
				url:'baseinfo/affiche/uploadImgageForAfficheFormAction!uploadImgage.action',
