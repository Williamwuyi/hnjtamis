 ...
 * 流程监控类
 */
ClassDefine('modules.workflow.Monitor', {
	...
	initComponent : function() {
		...
		this.terms = [{
						...
						defaultType : 'radio',
						items : [
						    {boxLabel : '全部', name : 'completType',inputValue : -1,checked : true},
							{boxLabel : '是', name : 'completType', inputValue : 1},
							{boxLabel : '否', name : 'completType', inputValue : 0}
						]
				     }];
		...
		this.listUrl = "workflow/flowMoniterForFlowTestAction!flowMoniter.action";// 列表请求地址
