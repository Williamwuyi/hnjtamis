 ...
 * 成绩查询
 */
ClassDefine('modules.hnjtamis.base.examScoreQuery.ExamScoreQuery', {
	...
	initComponent : function() {
		...
		this.terms = [{
					...
					editorType:'str',
					selectUrl : 'exam/exampaper/scoreQueryListForExampaperListAction!scoreQueryList.action?onlyexam=true',
					width:400,
		...
		this.listUrl = "base/scorequery/listForExamScoreQueryListAction!list.action";// 列表请求地址
