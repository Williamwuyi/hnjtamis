...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"modules/hnjtamis/train/resource/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"modules/hnjtamis/train/resource/");
    ...
    window[instance] = flashembed(id, {
        ...
        version					    : [10, 0],
        expressInstall			    : "modules/hnjtamis/train/resource/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
