 ...
 * 下拉树控件
 */
Ext.define('modules.hnjtamis.common.employeeTree.pxUserSelectTree', {
    extend : 'Ext.Panel',
	border : false,
	frame : true,
	...
	initComponent : function() {
		...
		me.deptNameTerm = new Ext.form.TextField({
			xtype : 'textfield',
			name  : 'deptNameTerm',
			fieldLabel : '&nbsp;&nbsp;部门|岗位',
			labelWidth : 90,
		...
		me.employeeNameTerm = new Ext.form.TextField({
			xtype : 'textfield',
			name  : 'employeeNameTerm',
			fieldLabel : '&nbsp;&nbsp;姓名',
			labelWidth : 50,
			width:180
		...
		me.termform = new Ext.Toolbar({
			...
			items : [
					...
					Ext.create("Ext.Button", {
						...
						handler : function() {
							me.deptTreeGrid.store.proxy.extraParams = {
								deptNameTerm:me.deptNameTerm.getValue(),
								employeeNameTerm : me.employeeNameTerm.getValue()
							}
							me.deptTreeGrid.store.load();
							
							
							me.unSelectStore.proxy.extraParams = {
								deptNameTerm:me.deptNameTerm.getValue(),
								employeeNameTerm : me.employeeNameTerm.getValue()
							}
							me.unSelectStore.load();
						}
					}),
					'->',
					Ext.create("Ext.Button", {
