...
function openXxTk(themebankid,name){
	...
	exeBodyMask.show();
	window.location = "${basePath}onlineExam/showMoniThemelistForOnlineListAction!showMoniThemelist.action?themeBankId="+themebankid+"&qtype="+qtype;
}
function openBjTk(themebankid,name){
	...
	exeBodyMask.show();
	window.location = "${basePath}onlineExam/showMoniThemelistForOnlineListAction!showMoniThemelist.action?showSign=1&themeBankId="+themebankid+"&qtype="+qtype;
}
...
function openTk(themebankid,name,examType){
	if(examType > 0.0 && examType <= 100.0){
		window.location = "${basePath}study/studyTheme/studyOnlineExamForStudyThemeListAction!studyOnlineExam.action?relationType=moni&themeBankId="+themebankid+"&isHidden=1&isRight=true&qtype="+qtype;
