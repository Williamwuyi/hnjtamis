 ...
 * 课件库
 */
ClassDefine('modules.hnjtamis.courseware.Courseware', {
	...
	initComponent : function() {
		...
		this.listUrl = "kb/course/listForCoursewareListAction!list.action?typeTerm=1&organId="+base.Login.userSession.currentOrganId;// 列表请求地址
